...
5. **Visual Verification:** 
   ...
   - Verify BMP file exists in `gfx/events_pics/`, is uncompressed 24-bit BMP, and has exact dimensions (**400Ã—232** for events, **224Ã—48** for decisions).

## Best Practices & Composition Guidelines

- **Portraits & Aspect Ratio (400Ã—232 = ~1.72:1):**
...
- Event pictures: **400Ã—232** BMP; template: `gfx/events_pics/template.png`.
- Decision pictures: **224Ã—48** BMP; template: `gfx/events_pics/decision_template.png`.
...
- **Decision Banner Framing (224Ã—48):** Due to the extreme wide aspect ratio (~4.67:1), prefer wide landscape scenes, maps, lines of soldiers, banners, reliefs, or insignia. Avoid tall vertical portraits unless a horizontal crop slice is visually coherent.
...
- Add a 1.0sâ€“1.5s delay between sequential automated downloads.